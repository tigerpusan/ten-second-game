...
ROOT=Path(__file__).resolve().parents[1]; WWW=ROOT/'www'; ANDROID=ROOT/'android/app/src/main/res'
BG=(255,151,15); PANEL=(255,247,239); OUT=(42,33,30); WHITE=(255,255,255); PINK=(255,176,167); YELLOW=(255,190,74); RED=(255,112,112)
def icon(size,round_=False):
 ...
 # strong 10 badge, recognisable at launcher size
...
print('Generated 10-second game icons.')